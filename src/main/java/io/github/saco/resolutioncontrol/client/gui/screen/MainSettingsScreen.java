package io.github.saco.resolutioncontrol.client.gui.screen;
...
import io.github.saco.resolutioncontrol.util.RCUtil;
...
public final class MainSettingsScreen extends SettingsScreen {
	...
	/*
	Migrated from literal to text.of (>1.19)

	private static final Text increaseText = new LiteralTextContent("+");
	private static final Text decreaseText = new LiteralTextContent("-");
	private static final Text setText = new LiteralTextContent("S");
	private static final Text resetText = new LiteralTextContent("R");
	private static final Text cancelText = new LiteralTextContent("C");
	*/
